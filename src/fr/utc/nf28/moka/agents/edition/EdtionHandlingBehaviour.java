...
import fr.utc.nf28.moka.agents.connection.ConnectionAgent;
...
/**
 * A behaviour that handles item edition.
 */
public class EdtionHandlingBehaviour extends CyclicBehaviour {
    @Override
    public void action() {
